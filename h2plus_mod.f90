module h2plus
   ...
   public :: init_h2plus
   public :: init_h2plus_v2
   public :: test_routine

contains
   function fun_s11one(xi, eta, Z1, Z2, m, C, R, jz2, alpha, beta) result(s11one)
   ...
   subroutine int_s11one_v2(b_i_xi, b_i_eta, b_j_xi, b_j_eta, knot_xi, knot_eta, d, Z1, Z2, m, C, R, jz2, result)
      ...
      do j1 = 1, size(prod_xi, 2) ! Loop over the order of xi
         do j2 = 1, size(prod_eta, 2) ! Loop over the order of eta
            alpha = size(prod_xi, 2) - j1
            beta = size(prod_eta, 2) - j2
            val_min_min = val_min_min + prod_xi(min_i, j1)*prod_eta(min_i, j2)*fun_s11one(knot_xi(min_i), knot_eta(min_i), Z1, Z2, m, C, R, jz2, alpha, beta)
            val_max_max = val_max_max + prod_xi(max_i, j1)*prod_eta(max_i, j2)*fun_s11one(knot_xi(max_i+1), knot_eta(max_i+1), Z1, Z2, m, C, R, jz2, alpha, beta)
            val_min_max = val_min_max + prod_xi(min_i, j1)*prod_eta(max_i, j2)*fun_s11one(knot_xi(min_i), knot_eta(max_i+1), Z1, Z2, m, C, R, jz2, alpha, beta)
            val_max_min = val_max_min + prod_xi(max_i, j1)*prod_eta(min_i, j2)*fun_s11one(knot_xi(max_i+1), knot_eta(min_i), Z1, Z2, m, C, R, jz2, alpha, beta)
         end do
      end do
   ...
   end subroutine int_s11one_v2

   function fun_s22one(xi, eta, Z1, Z2, m, C, R, jz2, alpha, beta) result(s22one)
   ...
   subroutine int_s22one_v2(b_i_xi, b_i_eta, b_j_xi, b_j_eta, knot_xi, knot_eta, d, Z1, Z2, m, C, R, jz2, result)
      ...
      do j1 = 1, size(prod_xi, 2) ! Loop over the order of xi
         do j2 = 1, size(prod_eta, 2) ! Loop over the order of eta
            alpha = size(prod_xi, 2) - j1
            beta = size(prod_eta, 2) - j2
            val_min_min = val_min_min + prod_xi(min_i, j1)*prod_eta(min_i, j2)*fun_s22one(knot_xi(min_i), knot_eta(min_i), Z1, Z2, m, C, R, jz2, alpha, beta)
            val_max_max = val_max_max + prod_xi(max_i, j1)*prod_eta(max_i, j2)*fun_s22one(knot_xi(max_i+1), knot_eta(max_i+1), Z1, Z2, m, C, R, jz2, alpha, beta)
            val_min_max = val_min_max + prod_xi(min_i, j1)*prod_eta(max_i, j2)*fun_s22one(knot_xi(min_i), knot_eta(max_i+1), Z1, Z2, m, C, R, jz2, alpha, beta)
            val_max_min = val_max_min + prod_xi(max_i, j1)*prod_eta(min_i, j2)*fun_s22one(knot_xi(max_i+1), knot_eta(min_i), Z1, Z2, m, C, R, jz2, alpha, beta)
         end do
      end do
      result = result + val_max_max + val_min_min - val_max_min - val_min_max
   ...
   end subroutine int_s22one_v2

   function fun_c11one(xi, eta, Z1, Z2, m, C, R, jz2, alpha, beta) result(c11one)
   ...
   subroutine int_c11one_v2(b_i_xi, b_i_eta, b_j_xi, b_j_eta, knot_xi, knot_eta, d, Z1, Z2, m, C, R, jz2, result)
      !> @brief This subroutine calculates the c11one integral for the H2+ molecule.
      !> @param b_i_xi : real(:, :) : the B-spline coefficients for the xi direction
      !> @param b_i_eta : real(:, :) : the B-spline coefficients for the eta direction
      !> @param b_j_xi : real(:, :) : the B-spline coefficients for the xi direction
      ...
      do j1 = 1, size(prod_xi, 2) ! Loop over the order of xi
         do j2 = 1, size(prod_eta, 2) ! Loop over the order of eta
            alpha = size(prod_xi, 2) - j1
            beta = size(prod_eta, 2) - j2
            val_min_min = val_min_min + prod_xi(min_i, j1)*prod_eta(min_i, j2)*fun_c11one(knot_xi(min_i), knot_eta(min_i), Z1, Z2, m, C, R, jz2, alpha, beta)
            val_max_max = val_max_max + prod_xi(max_i, j1)*prod_eta(max_i, j2)*fun_c11one(knot_xi(max_i+1), knot_eta(max_i+1), Z1, Z2, m, C, R, jz2, alpha, beta)
            val_min_max = val_min_max + prod_xi(min_i, j1)*prod_eta(max_i, j2)*fun_c11one(knot_xi(min_i), knot_eta(max_i+1), Z1, Z2, m, C, R, jz2, alpha, beta)
            val_max_min = val_max_min + prod_xi(max_i, j1)*prod_eta(min_i, j2)*fun_c11one(knot_xi(max_i+1), knot_eta(min_i), Z1, Z2, m, C, R, jz2, alpha, beta)
         end do
      end do
      result = result + val_max_max + val_min_min - val_max_min - val_min_max
   ...
   end subroutine int_c11one_v2

   function fun_c11two(xi, eta, Z1, Z2, m, C, R, jz2, alpha, beta) result(c11two)
   ...
   subroutine int_c11two_v2(b_i_xi, b_i_eta, b_j_xi, b_j_eta, knot_xi, knot_eta, d, Z1, Z2, m, C, R, jz2, result)
      !> @brief This subroutine calculates the c11two integral for the H2+ molecule.
      !> @param b_i_xi : real(:, :) : the B-spline coefficients for the xi direction
      !> @param b_i_eta : real(:, :) : the B-spline coefficients for the eta direction
      !> @param b_j_xi : real(:, :) : the B-spline coefficients for the xi direction
      ...
      do j1 = 1, size(prod_xi, 2) ! Loop over the order of xi
         do j2 = 1, size(prod_eta, 2) ! Loop over the order of eta
            alpha = size(prod_xi, 2) - j1
            beta = size(prod_eta, 2) - j2
            val_min_min = val_min_min + prod_xi(min_i, j1)*prod_eta(min_i, j2)*fun_c11two(knot_xi(min_i), knot_eta(min_i), Z1, Z2, m, C, R, jz2, alpha, beta)
            val_max_max = val_max_max + prod_xi(max_i, j1)*prod_eta(max_i, j2)*fun_c11two(knot_xi(max_i+1), knot_eta(max_i+1), Z1, Z2, m, C, R, jz2, alpha, beta)
            val_min_max = val_min_max + prod_xi(min_i, j1)*prod_eta(max_i, j2)*fun_c11two(knot_xi(min_i), knot_eta(max_i+1), Z1, Z2, m, C, R, jz2, alpha, beta)
            val_max_min = val_max_min + prod_xi(max_i, j1)*prod_eta(min_i, j2)*fun_c11two(knot_xi(max_i+1), knot_eta(min_i), Z1, Z2, m, C, R, jz2, alpha, beta)
         end do
      end do
      result = result + val_max_max + val_min_min - val_max_min - val_min_max
   ...
   subroutine int_C22one_v2(b_i_xi, b_i_eta, b_j_xi, b_j_eta, knot_xi, knot_eta, d, Z1, Z2, m, C, R, jz2, result)
      !> @brief This subroutine calculates the C22one integral for the H2+ molecule.
      !> @param b_i_xi : real(:, :) : the B-spline coefficients for the xi direction
      !> @param b_i_eta : real(:, :) : the B-spline coefficients for the eta direction
      !> @param b_j_xi : real(:, :) : the B-spline coefficients for the xi direction
      ...
      do j1 = 1, size(prod_xi, 2) ! Loop over the order of xi
         do j2 = 1, size(prod_eta, 2) ! Loop over the order of eta
            alpha = size(prod_xi, 2) - j1
            beta = size(prod_eta, 2) - j2
            val_min_min = val_min_min + prod_xi(min_i, j1)*prod_eta(min_i, j2)*fun_c22one(knot_xi(min_i), knot_eta(min_i), Z1, Z2, m, C, R, jz2, alpha, beta)
            val_max_max = val_max_max + prod_xi(max_i, j1)*prod_eta(max_i, j2)*fun_c22one(knot_xi(max_i+1), knot_eta(max_i+1), Z1, Z2, m, C, R, jz2, alpha, beta)
            val_min_max = val_min_max + prod_xi(min_i, j1)*prod_eta(max_i, j2)*fun_c22one(knot_xi(min_i), knot_eta(max_i+1), Z1, Z2, m, C, R, jz2, alpha, beta)
            val_max_min = val_max_min + prod_xi(max_i, j1)*prod_eta(min_i, j2)*fun_c22one(knot_xi(max_i+1), knot_eta(min_i), Z1, Z2, m, C, R, jz2, alpha, beta)
         end do
      end do
      result = result + val_max_max + val_min_min - val_max_min - val_min_max
   ...
   end subroutine int_C22one_v2

   function fun_c22two(xi, eta, Z1, Z2, m, C, R, jz2, alpha, beta) result(c22two)
   ...
   subroutine int_C22two_v2(b_i_xi, b_i_eta, b_j_xi, b_j_eta, knot_xi, knot_eta, d, Z1, Z2, m, C, R, jz2, result)
      !> @brief This subroutine calculates the C22two integral for the H2+ molecule.
      !> @param b_i_xi : real(:, :) : the B-spline coefficients for the xi direction
      !> @param b_i_eta : real(:, :) : the B-spline coefficients for the eta direction
      !> @param b_j_xi : real(:, :) : the B-spline coefficients for the xi direction
      ...
      do j1 = 1, size(prod_xi, 2) ! Loop over the order of xi
         do j2 = 1, size(prod_eta, 2) ! Loop over the order of eta
            alpha = size(prod_xi, 2) - j1
            beta = size(prod_eta, 2) - j2
            val_min_min = val_min_min + prod_xi(min_i, j1)*prod_eta(min_i, j2)*fun_c22two(knot_xi(min_i), knot_eta(min_i), Z1, Z2, m, C, R, jz2, alpha, beta)
            val_max_max = val_max_max + prod_xi(max_i, j1)*prod_eta(max_i, j2)*fun_c22two(knot_xi(max_i+1), knot_eta(max_i+1), Z1, Z2, m, C, R, jz2, alpha, beta)
            val_min_max = val_min_max + prod_xi(min_i, j1)*prod_eta(max_i, j2)*fun_c22two(knot_xi(min_i), knot_eta(max_i+1), Z1, Z2, m, C, R, jz2, alpha, beta)
            val_max_min = val_max_min + prod_xi(max_i, j1)*prod_eta(min_i, j2)*fun_c22two(knot_xi(max_i+1), knot_eta(min_i), Z1, Z2, m, C, R, jz2, alpha, beta)
         end do
      end do
      result = result + val_max_max + val_min_min - val_max_min - val_min_max
   ...
   end subroutine int_C22two_v2

   function fun_c11three(xi, eta, Z1, Z2, m, C, R, jz2, alpha, beta, gamma, delta) result(c11three)
      ...
      !> @param beta : real : the beta parameter
      type(mp_real) :: xi, eta, m, C, R, Z1, Z2
      integer :: jz2, alpha, beta, gamma, delta
      ...
      c11three = 2*mppi()*R**2*eta**(beta + gamma)*xi**(alpha + delta)*((delta*eta**4)/((alpha + delta)*(4 + beta + gamma)) + (xi**4*(2*gamma + (beta + gamma)*(eta**2*(delta - gamma) + gamma)))/((4 + alpha + delta)*(beta + gamma)*(2 + beta + gamma)) - (eta**2*xi**2*(gamma*(1/(2 + beta + gamma) - eta**2/(4 + beta + gamma)) + delta*(1/(2 + beta + gamma) + eta**2/(4 + beta + gamma))))/(2 + alpha + delta))
   ...
   subroutine int_C11three_v2(b_i_xi, b_i_eta, b_j_xi, b_j_eta, knot_xi, knot_eta, d, Z1, Z2, m, C, R, jz2, result)
      !> @brief This subroutine calculates the C11three integral for the H2+ molecule.
      !> @param b_i_xi : real(:, :) : the B-spline coefficients for the xi direction
      !> @param b_i_eta : real(:, :) : the B-spline coefficients for the eta direction
      !> @param b_j_xi : real(:, :) : the B-spline coefficients for the xi direction
      ...
      type(mp_real) :: val_max_max, val_min_min, val_max_min, val_min_max
      integer :: i, j1, j2, j3, j4, alpha, beta, gamma, delta, min_i, max_i

      zero = '0.0d0'

      ! Calculate the value of the S11 integral at each knot and take the difference
      min_i = d
      max_i = size(b_i_xi, 1) - d
      result = zero
      val_min_min = zero
      val_max_max = zero
      val_min_max = zero
         ...
         do j2 = 1, size(b_i_eta, 2) ! Loop over the order of eta i
            do j3 = 1, size(b_j_xi, 2) ! Loop over the order of xi j
               do j4 = 1, size(b_j_eta, 2) ! Loop over the order of eta j
                  ...
                  gamma = size(b_j_xi, 2) - j3
                  delta = size(b_j_eta, 2) - j4
                  val_min_min = val_min_min + b_i_xi(min_i, j1)*b_j_xi(min_i, j1)*b_i_eta(min_i, j2)*b_j_eta(min_i, j2)*fun_c11three(knot_xi(min_i), knot_eta(min_i), Z1, Z2, m, C, R, jz2, alpha, beta, gamma, delta)
                  val_max_max = val_max_max + b_i_xi(max_i, j1)*b_j_xi(min_i, j1)*b_i_eta(max_i, j2)*b_j_eta(min_i, j2)*fun_c11three(knot_xi(max_i+1), knot_eta(max_i+1), Z1, Z2, m, C, R, jz2, alpha, beta, gamma, delta)
                  val_min_max = val_min_max + b_i_xi(min_i, j1)*b_j_xi(min_i, j1)*b_i_eta(max_i, j2)*b_j_eta(min_i, j2)*fun_c11three(knot_xi(min_i), knot_eta(max_i+1), Z1, Z2, m, C, R, jz2, alpha, beta, gamma, delta)
                  val_max_min = val_max_min + b_i_xi(max_i, j1)*b_j_xi(min_i, j1)*b_i_eta(min_i, j2)*b_j_eta(min_i, j2)*fun_c11three(knot_xi(max_i+1), knot_eta(min_i), Z1, Z2, m, C, R, jz2, alpha, beta, gamma, delta)
               end do
            end do
         end do
      end do
   ...
   end subroutine int_C11three_v2

   function fun_c22three(xi, eta, Z1, Z2, m, C, R, jz2, alpha, beta, gamma, delta) result(c22three)
      ...
      c22three = (2*mppi()*R**2*eta**(beta + gamma)*xi**(alpha + delta)*((eta**2*xi**2*(2 + delta + delta*eta**2 - 2*(1 + delta)*eta**4 + (-1 + eta**2)**2*gamma - (2*(2 + beta - delta))/(2 + beta + gamma) + (2*(6 + beta + 2*delta)*eta**4)/(6 + beta + gamma)))/(2 + alpha + delta) + (delta*eta**4*(-1 + (eta**2*(4 + beta + gamma))/(6 + beta + gamma)))/(alpha + delta)-(xi**4*(-((gamma*(4 + beta + gamma))/(beta + gamma)) - (eta**2*(2*delta - gamma)*(4 + beta + gamma))/(2 + beta + gamma) + (eta**6*(delta - gamma)*(4 + beta + gamma))/(6 + beta + gamma) + eta**4*(delta + gamma)))/(4 + alpha + delta)-(xi**6*(8*gamma + (beta + gamma)*(delta*eta**2*(4 + beta - (2 + beta)*eta**2) - (-1 + eta**2)*(6 + beta + (-2 - beta + delta)*eta**2)*gamma + (-1 + eta**2)**2*gamma**2)))/((6 + alpha + delta)*(beta + gamma)*(2 + beta + gamma))))/(4 + beta + gamma)
   ...
   subroutine int_C22three_v2(b_i_xi, b_i_eta, b_j_xi, b_j_eta, knot_xi, knot_eta, d, Z1, Z2, m, C, R, jz2, result)
      !> @brief This subroutine calculates the C22three integral for the H2+ molecule.
      !> @param b_i_xi : real(:, :) : the B-spline coefficients for the xi direction
      !> @param b_i_eta : real(:, :) : the B-spline coefficients for the eta direction
      !> @param b_j_xi : real(:, :) : the B-spline coefficients for the xi direction
         ...
         do j2 = 1, size(b_i_eta, 2) ! Loop over the order of eta i
            do j3 = 1, size(b_j_xi, 2) ! Loop over the order of xi j
               do j4 = 1, size(b_j_eta, 2) ! Loop over the order of eta j
                  ...
                  gamma = size(b_j_xi, 2) - j3
                  delta = size(b_j_eta, 2) - j4
                  val_min_min = val_min_min + b_i_xi(min_i, j1)*b_j_xi(min_i, j1)*b_i_eta(min_i, j2)*b_j_eta(min_i, j2)*fun_c22three(knot_xi(min_i), knot_eta(min_i), Z1, Z2, m, C, R, jz2, alpha, beta, gamma, delta)
                  val_max_max = val_max_max + b_i_xi(max_i, j1)*b_j_xi(min_i, j1)*b_i_eta(max_i, j2)*b_j_eta(min_i, j2)*fun_c22three(knot_xi(max_i+1), knot_eta(max_i+1), Z1, Z2, m, C, R, jz2, alpha, beta, gamma, delta)
                  val_min_max = val_min_max + b_i_xi(min_i, j1)*b_j_xi(min_i, j1)*b_i_eta(max_i, j2)*b_j_eta(min_i, j2)*fun_c22three(knot_xi(min_i), knot_eta(max_i+1), Z1, Z2, m, C, R, jz2, alpha, beta, gamma, delta)
                  val_max_min = val_max_min + b_i_xi(max_i, j1)*b_j_xi(min_i, j1)*b_i_eta(min_i, j2)*b_j_eta(min_i, j2)*fun_c22three(knot_xi(max_i+1), knot_eta(min_i), Z1, Z2, m, C, R, jz2, alpha, beta, gamma, delta)
               end do
            end do
         end do
      end do
   ...
   end subroutine int_C22three_v2

   function fun_c12three(xi, eta, Z1, Z2, m, C, R, jz2, alpha, beta, gamma, delta) result(c12three)
      ...
      c12three = 2*mppi()*R**2*eta**(1 + beta + gamma)*xi**(1 + alpha + delta)*(-(1/(1 + alpha + delta)) + xi**2/(3 + alpha + delta))*(-delta + gamma)*(-(1/(1 + beta + gamma)) + eta**2/(3 + beta + gamma))
   ...
   subroutine int_C12three_v2(b_i_xi, b_i_eta, b_j_xi, b_j_eta, knot_xi, knot_eta, d, Z1, Z2, m, C, R, jz2, result)
      !> @brief This subroutine calculates the C12three integral for the H2+ molecule.
      !> @param b_i_xi : real(:, :) : the B-spline coefficients for the xi direction
      !> @param b_i_eta : real(:, :) : the B-spline coefficients for the eta direction
      !> @param b_j_xi : real(:, :) : the B-spline coefficients for the xi direction
         ...
         do j2 = 1, size(b_i_eta, 2) ! Loop over the order of eta i
            do j3 = 1, size(b_j_xi, 2) ! Loop over the order of xi j
               do j4 = 1, size(b_j_eta, 2) ! Loop over the order of eta j
                  ...
                  gamma = size(b_j_xi, 2) - j3
                  delta = size(b_j_eta, 2) - j4
                  val_min_min = val_min_min + b_i_xi(min_i, j1)*b_j_xi(min_i, j1)*b_i_eta(min_i, j2)*b_j_eta(min_i, j2)*fun_c12three(knot_xi(min_i), knot_eta(min_i), Z1, Z2, m, C, R, jz2, alpha, beta, gamma, delta)
                  val_max_max = val_max_max + b_i_xi(max_i, j1)*b_j_xi(min_i, j1)*b_i_eta(max_i, j2)*b_j_eta(min_i, j2)*fun_c12three(knot_xi(max_i+1), knot_eta(max_i+1), Z1, Z2, m, C, R, jz2, alpha, beta, gamma, delta)
                  val_min_max = val_min_max + b_i_xi(min_i, j1)*b_j_xi(min_i, j1)*b_i_eta(max_i, j2)*b_j_eta(min_i, j2)*fun_c12three(knot_xi(min_i), knot_eta(max_i+1), Z1, Z2, m, C, R, jz2, alpha, beta, gamma, delta)
                  val_max_min = val_max_min + b_i_xi(max_i, j1)*b_j_xi(min_i, j1)*b_i_eta(min_i, j2)*b_j_eta(min_i, j2)*fun_c12three(knot_xi(max_i+1), knot_eta(min_i), Z1, Z2, m, C, R, jz2, alpha, beta, gamma, delta)
               end do
            end do
         end do
      end do
   ...
   end subroutine int_C12three_v2

   function fun_c21three(xi, eta, Z1, Z2, m, C, R, jz2, alpha, beta, gamma, delta) result(c21three)
      ...
      c21three = 2*mppi()*R**2*eta**(1 + beta + gamma)*xi**(1 + alpha + delta)*(-(1/(1 + alpha + delta)) + xi**2/(3 + alpha + delta))*(-delta + gamma)*(-(1/(1 + beta + gamma)) + eta**2/(3 + beta + gamma))
   ...
   subroutine int_C21three_v2(b_i_xi, b_i_eta, b_j_xi, b_j_eta, knot_xi, knot_eta, d, Z1, Z2, m, C, R, jz2, result)
      !> @brief This subroutine calculates the C21three integral for the H2+ molecule.
      !> @param b_i_xi : real(:, :) : the B-spline coefficients for the xi direction
      !> @param b_i_eta : real(:, :) : the B-spline coefficients for the eta direction
      !> @param b_j_xi : real(:, :) : the B-spline coefficients for the xi direction
         ...
         do j2 = 1, size(b_i_eta, 2) ! Loop over the order of eta i
            do j3 = 1, size(b_j_xi, 2) ! Loop over the order of xi j
               do j4 = 1, size(b_j_eta, 2) ! Loop over the order of eta j
                  ...
                  gamma = size(b_j_xi, 2) - j3
                  delta = size(b_j_eta, 2) - j4
                  val_min_min = val_min_min + b_i_xi(min_i, j1)*b_j_xi(min_i, j1)*b_i_eta(min_i, j2)*b_j_eta(min_i, j2)*fun_c21three(knot_xi(min_i), knot_eta(min_i), Z1, Z2, m, C, R, jz2, alpha, beta, gamma, delta)
                  val_max_max = val_max_max + b_i_xi(max_i, j1)*b_j_xi(min_i, j1)*b_i_eta(max_i, j2)*b_j_eta(min_i, j2)*fun_c21three(knot_xi(max_i+1), knot_eta(max_i+1), Z1, Z2, m, C, R, jz2, alpha, beta, gamma, delta)
                  val_min_max = val_min_max + b_i_xi(min_i, j1)*b_j_xi(min_i, j1)*b_i_eta(max_i, j2)*b_j_eta(min_i, j2)*fun_c21three(knot_xi(min_i), knot_eta(max_i+1), Z1, Z2, m, C, R, jz2, alpha, beta, gamma, delta)
                  val_max_min = val_max_min + b_i_xi(max_i, j1)*b_j_xi(min_i, j1)*b_i_eta(min_i, j2)*b_j_eta(min_i, j2)*fun_c21three(knot_xi(max_i+1), knot_eta(min_i), Z1, Z2, m, C, R, jz2, alpha, beta, gamma, delta)
               end do
            end do
         end do
      end do
   ...
   end subroutine int_C21three_v2
   ...
   subroutine init_h2plus_v2(d, n, n_remove, Z1, Z2, m, C, R, ximax, ximin, jz2, epsilon, eta_slp, save_step)
      !> @brief This subroutine initializes the B-spline coefficients for the H2+ molecule.
      !> @param d : integer : the degree of the B-spline
      !> @param n : integer : the number of usable B-splines
      !> @param n_remove : integer : the number of knots to remove from each end
      ...
      do i = 1, n**2 ! Loop over the number of B-splines
         do j = 1, n**2
            ...
            S11one(i, j) = zero
            call int_s11one_v2(bspline_xi(i2(1), :, :), bspline_eta(i2(2), :, :), &
                            bspline_xi(j2(1), :, :), bspline_eta(j2(2), :, :), &
                            knotxi_eps, knoteta_eps, d, Z1, Z2, m, C, R, jz2, S11one(i, j))
         end do
      end do
      !$OMP END PARALLEL DO
      ...
      do i = 1, n**2 ! Loop over the number of B-splines
         do j = 1, n**2
            ...
            S22one(i, j) = zero
            call int_s22one_v2(bspline_xi(i2(1), :, :), bspline_eta(i2(2), :, :), &
                            bspline_xi(j2(1), :, :), bspline_eta(j2(2), :, :), &
                            knotxi_eps, knoteta_eps, d, Z1, Z2, m, C, R, jz2, S22one(i, j))
         end do
      end do
      !$OMP END PARALLEL DO
      ...
      do i = 1, n**2 ! Loop over the number of B-splines
         do j = 1, n**2
            ...
            C11one(i, j) = zero
            call int_C11one_v2(bspline_xi(i2(1), :, :), bspline_eta(i2(2), :, :), &
                            bspline_xi(j2(1), :, :), bspline_eta(j2(2), :, :), &
                            knotxi_eps, knoteta_eps, d, Z1, Z2, m, C, R, jz2, C11one(i, j))
         end do
      end do
      !$OMP END PARALLEL DO
      ...
      do i = 1, n**2 ! Loop over the number of B-splines
         do j = 1, n**2
            ...
            C11two(i, j) = zero
            call int_C11two_v2(bspline_xi(i2(1), :, :), bspline_eta(i2(2), :, :), &
                            bspline_xi(j2(1), :, :), bspline_eta(j2(2), :, :), &
                            knotxi_eps, knoteta_eps, d, Z1, Z2, m, C, R, jz2, C11two(i, j))
         end do
      end do
      !$OMP END PARALLEL DO
      ...
      do i = 1, n**2 ! Loop over the number of B-splines
         do j = 1, n**2
            ...
            C22one(i, j) = zero
            call int_C22one_v2(bspline_xi(i2(1), :, :), bspline_eta(i2(2), :, :), &
                            bspline_xi(j2(1), :, :), bspline_eta(j2(2), :, :), &
                            knotxi_eps, knoteta_eps, d, Z1, Z2, m, C, R, jz2, C22one(i, j))
         end do
      end do
      !$OMP END PARALLEL DO
      ...
      do i = 1, n**2 ! Loop over the number of B-splines
         do j = 1, n**2
            ...
            C22two(i, j) = zero
            call int_C22two_v2(bspline_xi(i2(1), :, :), bspline_eta(i2(2), :, :), &
                            bspline_xi(j2(1), :, :), bspline_eta(j2(2), :, :), &
                            knotxi_eps, knoteta_eps, d, Z1, Z2, m, C, R, jz2, C22two(i, j))
         end do
      end do
      !$OMP END PARALLEL DO
      ...
      do i = 1, n**2 ! Loop over the number of B-splines
         do j = 1, n**2
            ...
            C11three(i, j) = zero
            call int_C11three_v2(bspline_xi(i2(1), :, :), bspline_eta(i2(2), :, :), &
                              bspline_xi(j2(1), :, :), bspline_eta(j2(2), :, :), &
                              knotxi_eps, knoteta_eps, d, Z1, Z2, m, C, R, jz2, C11three(i, j))
         end do
      end do
      !$OMP END PARALLEL DO
      ...
      do i = 1, n**2 ! Loop over the number of B-splines
         do j = 1, n**2
            ...
            C22three(i, j) = zero
            call int_C22three_v2(bspline_xi(i2(1), :, :), bspline_eta(i2(2), :, :), &
                              bspline_xi(j2(1), :, :), bspline_eta(j2(2), :, :), &
                              knotxi_eps, knoteta_eps, d, Z1, Z2, m, C, R, jz2, C22three(i, j))
         end do
      end do
      !$OMP END PARALLEL DO
      ...
      do i = 1, n**2 ! Loop over the number of B-splines
         do j = 1, n**2
            ...
            C12three(i, j) = zero
            call int_C12three_v2(bspline_xi(i2(1), :, :), bspline_eta(i2(2), :, :), &
                              bspline_xi(j2(1), :, :), bspline_eta(j2(2), :, :), &
                              knotxi_eps, knoteta_eps, d, Z1, Z2, m, C, R, jz2, C12three(i, j))
         end do
      end do
      !$OMP END PARALLEL DO
      ...
      do i = 1, n**2 ! Loop over the number of B-splines
         do j = 1, n**2
            ...
            C21three(i, j) = zero
            call int_C21three_v2(bspline_xi(i2(1), :, :), bspline_eta(i2(2), :, :), &
                              bspline_xi(j2(1), :, :), bspline_eta(j2(2), :, :), &
                              knotxi_eps, knoteta_eps, d, Z1, Z2, m, C, R, jz2, C21three(i, j))
         end do
      end do
      !$OMP END PARALLEL DO
   ...
   subroutine test_routine(d, n, n_remove, Z1, Z2, m, C, R, ximax, ximin, jz2, epsilon, eta_slp, save_step)
      ...
      type(mp_real), dimension(:), allocatable :: knotxi, knoteta, knotxi_eps, knoteta_eps
      type(mp_real), dimension(:, :), allocatable :: C22one
      type(mp_real), dimension(:, :, :), allocatable :: bspline_xi, bspline_eta
      logical :: debug_bool = .true.
      ...
      do i = 1, n**2
            call write_lists(C22one(i, :), 6, 30, 10)
      end do
